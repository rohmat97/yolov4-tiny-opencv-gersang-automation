...
echo ==============================================================
echo              GERSANG AUTO LOGIN INITIALIZER
echo ==============================================================
...
echo.
echo Requesting Administrator privileges to run the auto-login script...
powershell -Command "Start-Process cmd -ArgumentList '/c \"\"%PYTHON_EXE%\" \"%~dp0auto_login.py\"\"' -WorkingDirectory '%~dp0' -Verb RunAs -Wait"
