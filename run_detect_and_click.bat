...
echo ==============================================================
echo            GERSANG DETECTOR & CLICKER INITIALIZER
echo ==============================================================
...
echo.
echo Requesting Administrator privileges to run the detector script...
powershell -Command "Start-Process cmd -ArgumentList '/k \"\"%PYTHON_EXE%\" \"%~dp04_yolo_opencv_detector.py\"\"' -WorkingDirectory '%~dp0' -Verb RunAs"
if !errorlevel! neq 0 (
